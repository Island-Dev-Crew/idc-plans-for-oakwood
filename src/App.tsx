...
const sources = [
  ...
  { id:'05', title:'IDC Oakwood AI Studio + Engineering Lab', detail:'May 26 walkthrough, 71-photo archive, room/power/network assessment, June 2026 proposal and budget.', url:'https://oakwood-ai-hub.vercel.app/ai-lab-idc/', type:'IDC documented evidence' as Claim },
    ...
    <main id="main">
      ...
      <section className="assets paper" id="assets">
        ...
        <div className="asset-mosaic">
          <article className="asset feature reveal"><img loading="lazy" decoding="async" src="./assets/evidence-power-data.webp" alt="Verified Oakwood room power and data condition"/><div className="asset-overlay"><ClaimTag>IDC documented evidence</ClaimTag><h3>71-photo on-site evidence archive</h3><p>May 26, 2026 walkthrough of Rooms 409, 407, 305/310, MDF, power, data, HVAC, windows and reusable assets.</p></div></article>
        ...
        <div className="campus-case reveal">
          ...
          <div className="case-stats"><div><b>51</b><span>buildings documented</span></div><div><b>57</b><span>departments indexed</span></div><div><b>94</b><span>accessibility attributes</span></div><div><b>27</b><span>recorded iterations</span></div></div>
        </div>
      </section>
